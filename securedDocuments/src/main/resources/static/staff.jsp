...
<html lang="en">
  ...
  <body>  
    ...
    <div class="templatemo-flex-row">
      ...
      <ul>
            <li><a href="staff.jsp" class="active"><i class="fa fa-home fa-fw"></i>PROFILE</a></li>
            <li><a href="create.jsp"><i class="fa fa-user-plus fa-fw"></i>CREATE USER</a></li>
            <li><a href="setting.jsp"><i class="fa fa-wrench fa-fw"></i>SETTINGS</a></li>
            <li><a href="DisplayLog"><i class="fa  fa-database fa-fw"></i>UPLOAD LOG </a></li>
...
<%
        session.setAttribute("set", "staff");
