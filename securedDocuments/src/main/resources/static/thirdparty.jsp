...
<html lang="en">
  ...
  <body>  
    ...
    <div class="templatemo-flex-row">
      ...
      <ul>
            <li><a href="thirdparty.jsp" class="active"><i class="fa fa-home fa-fw"></i>PROFILE</a></li>
            <li><a href="scan.jsp" ><i class="fa fa-user-plus fa-fw"></i>SCAN QR CODE</a></li>
            <li><a href="tpsetting.jsp"><i class="fa fa-user-plus fa-fw"></i>SETTING</a></li>
...
<%    session.setAttribute("set", "thirdparty");
