...
String query="select * from documents where uname='"+username+"'";
    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
     <li><a href="user.jsp"><i class="fa fa-home fa-fw"></i>PROFILE</a></li>
            <li><a href="documents.jsp"  class="active"><i class="fa fa-user-plus fa-fw"></i>Documents</a></li>
            <li><a href="user-setting.jsp"><i class="fa  fa-database fa-fw"></i>Setting</a></li>
        ...
        <div class="templatemo-content-container">
            ...
            <div class="panel panel-default table-responsive">
              ...
              <table class="table table-striped table-bordered templatemo-user-table">
                ...
                <tbody>     <%while(ii.hasNext()&& ii1.hasNext()){ Object element=ii.next(); Object element1=ii1.next(); incre++;%>
                  <tr>
                    <td><%=incre%></td>
                    <td><%=element%></td>
                    <td>Yes</td>
                    ...
                    <td>    
                        <input type="checkbox" name="documents" id="<%=incre%>" value="<%=element1%>"/> 
                        <label for="<%=incre%>"><span></span></label>  </td>
                 ...
                 <div class="col-lg-6 col-md-4 form-group">    <input type="text" class="form-control" maxlength="20" id="fn" name="tp" placeholder="Enter the Username to be shared" required> 
                 </div> <input type="submit"  class="templatemo-blue-button" value=" Create Qrcode ">    </form>
  ...
  <div class="modal fade" id="ViewPhoto" role="dialog">
    <div class="modal-dialog">
     ...
     <div class="modal-body">
          <center> <img src='userDisplay.jsp?documents=photo' height='300' width='300'>
          </center>
          </br>
      </div>   
    </div>
...
<!-- to display pan card-->  
   <div class="modal fade" id="ViewPan" role="dialog">
    <div class="modal-dialog">
     ...
     <div class="modal-body">
          <center> <img src='userDisplay.jsp?documents=pan_card' height='300' width='300'>
          </center>
          </br>
      </div>   
    </div>
 ...
 <!-- to display passport-->  
  ...
  <div class="modal fade" id="ViewCaste" role="dialog">
    <div class="modal-dialog">
     ...
     <div class="modal-body">
          <center> <img src='userDisplay.jsp?documents=caste_cert' height='300' width='300'>
          </center>
          </br>
      </div>   
    </div>
  ...
  <div class="modal fade" id="ViewElectricity" role="dialog">
    <div class="modal-dialog">
     ...
     <div class="modal-body">
          <center> <img src='userDisplay.jsp?documents=electricity_bill' height='300' width='300'>
          </center>
          </br>
      </div>   
    </div>
  ...
  <div class="modal fade" id="ViewAdhar" role="dialog">
    <div class="modal-dialog">
     ...
     <div class="modal-body">
          <center> <img src='userDisplay.jsp?documents=adhar_card' height='300' width='300'>
          </center>
          </br>
      </div>   
    </div>
  ...
  <div class="modal fade" id="ViewRation" role="dialog">
    <div class="modal-dialog">
     ...
     <div class="modal-body">
          <center> <img src='userDisplay.jsp?documents=ration_card' height='300' width='300'>
          </center>
          </br>
      </div>   
    </div>
  ...
  <div class="modal fade" id="ViewLicence" role="dialog">
    <div class="modal-dialog">
     ...
     <div class="modal-body">
          <center> <img src='userDisplay.jsp?documents=d_licence' height='300' width='300'>
          </center>
          </br>
      </div>   
    </div>
  ...
  <div class="modal fade" id="ViewBC" role="dialog">
    <div class="modal-dialog">
     ...
     <div class="modal-body">
          <center> <img src='userDisplay.jsp?documents=birth_cert' height='300' width='300'>
          </center>
          </br>
      </div>   
    </div>
  ...
  <div class="modal fade" id="ViewUncat" role="dialog">
    <div class="modal-dialog">
     ...
     <div class="modal-body">
          <center> <img src='userDisplay.jsp?documents=uncat_file' height='300' width='300'>
          </center>
          </br>
      </div>   
    </div>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h2> QR CODE FOR:-<div1 class="uname"></div1> </b></h2>
         </div> 
          <div class="modal-body">
          <center> <img src='DisplayImage' height='300' width='300'></br>
          <a href="DisplayImage" download="qrcode_EIN" class="templatemo-blue-button">Download</a>
