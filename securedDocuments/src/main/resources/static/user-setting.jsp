  ...
  <body>
    ...
    <div class="templatemo-flex-row">
     ...
     <ul>
            ...
            <li><a href="user-setting.jsp" class="active"><i class="fa fa-sliders fa-fw"></i>SETTINGS</a></li>
           <li><a href="documents.jsp" ><i class="fa fa-sliders fa-fw"></i>DOCUMENTS</a></li>
